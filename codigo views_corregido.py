...
from flask import request, redirect, url_for, flash, render_template  # Importamos las funciones necesarias para manejar las solicitudes y redirecciones en Flask
    ...
    def index(self):
        ...
        if form.validate_on_submit():
            ...
            if user:
                ...
                flash('User not found', 'error')
            return redirect(url_for('.index'))
        return self.render('admin/delete_user.html'